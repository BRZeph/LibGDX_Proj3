...
import me.BRZeph.Screens.MiscelaneousScreens.*;
...
public class ScreenManager {
    ...
    public void showMTD(){
        switchScreen(new MTDScreen(this,assetManager));
    }
    ...
    public void showUIDevelopment() {
        switchScreen(new UIDevelopment(this, assetManager));
    }
